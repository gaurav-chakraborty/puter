...
> Open-source, self-hostable internet-computer platform with local development, Docker, deployment, and translation workflows.
...
| Report a problem | [Open an issue](https://github.com/gaurav-chakraborty/puter/issues). Include reproduction steps, logs, versions, and expected versus actual behavior. |
...
| Resource | Link |
|---|---|
| Source repository | [GitHub](https://github.com/gaurav-chakraborty/puter) |
| Issues and discussions | [Issues](https://github.com/gaurav-chakraborty/puter/issues) |
| Change history | [Commits](https://github.com/gaurav-chakraborty/puter/commits/main) |
| Automation | [Actions](https://github.com/gaurav-chakraborty/puter/actions) |
| Project site or primary external link | [https://puter.com](https://puter.com) |
